...
- Utilizing some of the variables from the prior question, this question aims
to determine which states on average are the healthiest based on general health.

**Research question 2:**

## Is there a relationship overall health, income, and education?
- Variables: genhlth, income2, educa, sex.

- This is an important and relevant question, as it may shed light on whether or
not those that have a higher income potentially have access to better healthcare,
nutritious food, etc. In addition to this, education level will also be taken
int account.
...
```{r}
ggplot(brfss2013, aes(x = X_state, y = genhlth)) +
  geom_line()
```
